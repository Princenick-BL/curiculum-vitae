...
import FileUploader from '@brainhubeu/react-file-input'
                            ...
                            <div className="demande" key={index}>
                                <div className="w100 orientationH">
                                    ...
                                    <div className="demande_right orientationV spaceBetween">
                                        ...
                                        <img title="Supprimer" src="/images/icon_delete_white.png" className= "smallIcon"/>
                                    </div>
                        ...
                        <div className="new_demande underline orientationH spaceBetween w100">
                            ...
                            <div className="orientationV">
                                ...
                                <div className=" file w100 orientationV spaceBetween ">
                                    ...
                                    <input type="file"  name="avatar" accept="application/pdf,application/vnd.ms-excel" required onChange={(e)=>{job_presentation_pdf_info( e);console.log(e.target.files[0])}}/>
                                </div>
